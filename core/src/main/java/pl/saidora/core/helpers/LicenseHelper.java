...
public class LicenseHelper {
	...
	public LicenseHelper(String licenseKey, String validationServer, Plugin plugin) {
		this.licenseKey = licenseKey;
		this.plugin = plugin;
		this.validationServer = validationServer;
	}

	public LicenseHelper setSecurityKey(String securityKey) {
		this.securityKey = securityKey;
		return this;
	}

	public LicenseHelper setConsoleLog(LogType logType) {
		this.logType = logType;
		return this;
	}

	public LicenseHelper debug() {
		debug = true;
		return this;
	}

	public boolean register(boolean disable) {
		log(0, "[==========[LICENSE]==========]");
