...
public class GuildRegionBlockPlaceEvent implements CallbackEvent<GuildRegionBlockPlaceEvent> {
    ...
    public GuildRegionBlockPlaceEvent(Guild guild, User user, Block block, Function<User, Boolean> function){
        this.guild = guild;
        this.user = user;
        this.block = block;
    ...
    @Override
    public Set<Consumer<GuildRegionBlockPlaceEvent>> getCache() {
        return EventCache.GUILD_REGION_BLOCK_PLACE_EVENT;
    }
