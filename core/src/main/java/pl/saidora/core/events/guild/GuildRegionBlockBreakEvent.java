...
public class GuildRegionBlockBreakEvent implements CallbackEvent<GuildRegionBlockBreakEvent> {
    ...
    public GuildRegionBlockBreakEvent(Guild guild, User user, Block block, Function<User, Boolean> function){
        this.guild = guild;
        this.user = user;
        this.block = block;
    ...
    @Override
    public Set<Consumer<GuildRegionBlockBreakEvent>> getCache() {
        return EventCache.GUILD_REGION_BLOCK_BREAK_EVENT;
    }
